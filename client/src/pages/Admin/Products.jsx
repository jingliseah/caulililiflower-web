    ...
    <div>
      ...
      <div className="card p-4 mb-6 flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        ...
        <div className="flex gap-2 flex-wrap">
          <SelectFilter value={availability} onChange={setAvailability} options={AVAILABILITY} />
          <SelectFilter value={categoryId}   onChange={setCategoryId}   options={categoryOptions} />
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {hasFilters && (
          <button onClick={clearFilters} className="text-body-3 brand-primary hover:opacity-70 transition">
            Clear filters
          </button>
        )}
      </div>
